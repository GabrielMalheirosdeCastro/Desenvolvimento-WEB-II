...
| RNF10 | Internacionalização | pt-BR como idioma principal + seletor PT-BR/EN-US funcional (i18n client-side, v1.16.0); extração incremental dos textos das telas: tela inicial (v1.19.0) e Plano de Estudos (v1.20.0) |
